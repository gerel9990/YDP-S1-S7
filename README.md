...
<body>
  ...
  let result = "";
  if (counts.A >= 4) {
    result = `<b>Баруун тархи <br>
        <li>
            <ol>Бүтээлч сэтгэхүй сайтай</ol>
            <ol>Мөрөөдөмтгий</ol>
            <ol>Сонссоноо мартдаггүй</ol>
            <ol>Мэдрэмж өндөртэй</ol>
            <ol>Үнэрлэх, амтлах нь маш чухал</ol>
            <ol>Хэсэгчлэн биш бүтнээр нь тусгадаг</ol>
            <ol>Дотоод мэдрэмжээ их ашигладаг</ol>
            <ol>Субьектив</ol>
    ...
    result = `<b>Зүүн тархи <br>
        <li>
            ...
            <ol>Ангилах, нэрлэх, дарааллуулах, хүснэгтлэх, задлан шинжлэх чадвартай</ol>
            <ol>Математикийн үйлдлүүдийг сайн хийдэг</ol>
            <ol>Үг хэллэгийг шууд утгаар нь хэрэглэдэг</ol>
            <ol>Нарийн төвөгтэй зүйлүүдийг сайн олж хардаг</ol>
            <ol>Бүтнээр биш хэсэгчлэн тусгадаг</ol>
            <ol>Системтэй дэг журамтай ажилладаг</ol>
            <ol>Объектив</ol>
            <ol>Аливаад бодитой ханддаг</ol>
        </li>`;
  }
  else {
    result = `
